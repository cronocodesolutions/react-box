...
export const propertyGroups: ParityGroup[] = [
  {
    ...
    rows: [
      ...
      {
        tailwind: 'top / right / bottom / left / inset',
        props: ['top', 'right', 'bottom', 'left', 'inset', 'insetX', 'insetY'],
        status: 'has',
        note: 'insetX/insetY are the logical inset-inline/inset-block',
      },
  ...
  },
  {
    name: 'Spacing & Sizing',
    rows: [
      { tailwind: 'padding', props: ['p', 'px', 'py', 'pt', 'pr', 'pb', 'pl'], status: 'has', note: 'divider 4 — p={4} is 1rem' },
      { tailwind: 'margin', props: ['m', 'mx', 'my', 'mt', 'mr', 'mb', 'ml'], status: 'has' },
  ...
  },
  {
    ...
    rows: [
      ...
      { tailwind: 'text-align', props: ['textAlign'], status: 'has' },
  ...
  },
  {
    ...
    rows: [
      ...
      { tailwind: 'border-width', props: ['b', 'bx', 'by', 'bt', 'br', 'bb', 'bl'], status: 'has', note: 'direct px — b={1} is 1px' },
...
export const variantGroups: ParityGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { tailwind: 'rtl / ltr', props: [], status: 'none', note: 'the logical properties are landing first' },

---
name: sync-docs
description: Update Box Kite usage documentation across BOX_KITE_AI_CONTEXT.md, local skill, and marketplace skill, keeping all three files in sync
argument-hint: <description of what to add or change>
---

Synchronize the Box Kite library documentation across all three files that describe usage for AI assistants.

## Target Files

1. **`src/BOX_KITE_AI_CONTEXT.md`** — Comprehensive detailed reference. Full prop tables, extensive code examples, complete API docs.
2. **`.claude/skills/box-kite/SKILL.md`** — **Maximally condensed** Claude Code skill. Same topics but as compact as possible. Has YAML frontmatter.
3. **`marketplace-skill/skills/box-kite/SKILL.md`** — Must be **identical** to file #2. Always copy #2 to #3 after editing.
...
3. **Update `src/BOX_KITE_AI_CONTEXT.md`** (detailed version):
...
4. **Update `.claude/skills/box-kite/SKILL.md`** (maximally condensed):
   ...
   - Do NOT add sections unique to BOX_KITE_AI_CONTEXT.md ("Key Reminders for AI Assistants", "Debugging Tips").
   - Do NOT remove sections unique to SKILL.md ("Installation & Package Management").

5. **Copy to marketplace**: after editing file #2, copy its content **verbatim** to `marketplace-skill/skills/box-kite/SKILL.md`.

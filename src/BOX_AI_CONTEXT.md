...
Runtime CSS-in-JS library. `Box` component accepts 197 CSS props and generates CSS classes at runtime. Same prop values share a single class.
...
| `top` / `right` / `bottom` / `left` / `inset` / `insetX` / `insetY`                                                                                                                  | positioning offsets                     | number (rem/4), `'auto'`, fractions (`'1/2'`, `'-1/3'`), percentages. `insetX`/`insetY` are the logical shorthands `inset-inline`/`inset-block`, the way `mx`/`my` are `margin-inline`/`margin-block`                                                                                                                                                                                                                                                                                                                                                                                                                   |

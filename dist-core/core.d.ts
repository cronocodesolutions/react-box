...
export { applyThemeToElement, clearStoredTheme, defaultThemeName, documentRoot, getSystemTheme, readStoredTheme, setThemeAttribute, watchSystemTheme, writeStoredTheme, } from './core/theme/themeRuntime';

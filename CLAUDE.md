...
@cronocode/react-box is a React runtime CSS-in-JS library. The core `Box` component accepts 155 CSS props and generates CSS classes at runtime — no CSS files needed. Same prop values across components share a single CSS class.
...
- `src/core/boxStyles.ts` — All CSS property definitions (155 props). Types auto-generate from these definitions
